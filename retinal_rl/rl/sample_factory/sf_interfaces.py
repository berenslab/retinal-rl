...
from sample_factory.utils.typing import ActionDistribution, ActionSpace
...
class ActorCriticProtocol(Protocol):
    ...
    def get_action_parameterization(
        self, decoder_output_size: int
    ) -> ActionsParameterization: ...
