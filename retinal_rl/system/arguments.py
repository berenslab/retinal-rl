...
def add_retinal_env_eval_args(parser):
    ...
    parser.add_argument("--receptive_fields", default=False, type=str2bool, help="Analyze receptive fields of network.")
    parser.add_argument("--simulate", default=False, type=str2bool, help="Runs simulations and analyses")
    parser.add_argument("--plot", default=False, type=str2bool, help="Generate static plots")
    parser.add_argument("--animate", default=False, type=str2bool, help="Animate 'analysis_out.npy'")
